...
@section('body')
      <main class="main">
        <div class="container_body">
          <div class="content">
            <form action="{{URL::to('/luudoan')}}" method="post" id ="form__add" class="form__add" enctype="multipart/form-data">
            @csrf
              <div class="form_add__name first_add_item">
                <label class="form_text" for="name">Tên thực đơn mới</label> <br>
                <input class="form_add__input" type="text" name="tensp" placeholder="Nhập tên đồ ăn hoặc đồ uống">
              </div>
              ...
              <div class="form_add__name">
                ...
                <input class="form_add__input" type="text" name="gia" placeholder="Nhập đơn giá">
              </div>
                    
              <div class="form_add__name">
                <br><label class="form_text" for="date">Miêu tả</label> <br>
                <input class="form_add__input" type="text" name="mieuta" placeholder="Miêu tả">
              </div>
