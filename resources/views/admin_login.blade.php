...
<body>
    <div class="main">
        <form action="admin-dashboard" methode ="POST" class="form" id="form-2">
            @csrf
            ...
            <div class="form-group">
                ...
                <input id="email" name="email_admin" type="text" placeholder="VD: email@domain.com" class="form-control">
                <span class="form-message"></span>
            </div>

            <div class="form-group">
                <label for="password" class="form-label">Mật khẩu</label>
                <input id="password" name="password_admin" type="password" placeholder="Nhập mật khẩu" class="form-control">
                <span class="form-message"></span>
            </div>
